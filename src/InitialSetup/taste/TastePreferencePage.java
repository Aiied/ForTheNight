...
public class TastePreferencePage extends JFrame {
    ...
    private JPanel createResultView() {
        ...
        resultDescriptionArea.setFont(ThemeFonts.plain(19));
    ...
    private JLabel createTitleLabel(String text) {
        ...
        label.setFont(ThemeFonts.bold(34));
        return label;
    }
    ...
    private JPanel createQuestionCard(int index, TasteQuestion question) {
        ...
        leftOptionLabel.setFont(ThemeFonts.plain(15));
    ...
    private JButton createActionButton(String text, int width) {
        JButton button = new AbstractActionButton(text, ScreenScale.scale(15)) {
