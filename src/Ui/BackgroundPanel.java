...
public class BackgroundPanel extends JPanel {
    private static final String IMAGE_PATH = "src/assets/image/Ui/DarkWoodBackground.png";
    private static final Image BACKGROUND_IMAGE = new ImageIcon(IMAGE_PATH).getImage();
